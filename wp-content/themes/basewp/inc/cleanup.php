<?php
add_action( 'init', 'base_disable_gutenberg' );        // https://metabox.io/disable-gutenberg-without-using-plugins/
add_action( 'init', 'base_disable_emojis' );           // https://wordpress.stackexchange.com/q/185577/
add_action( 'init', 'base_disable_oembed' );           // https://wordpress.stackexchange.com/q/211467/
add_action('init', 'base_disable_query_strings');    // https://stackoverflow.com/q/38288476/
add_action( 'init', 'base_disable_head_links' );

function base_disable_gutenberg() {
    function base_disable_gutenberg_scripts() {
        wp_dequeue_style( 'wp-block-library' );
    }
    add_action( 'wp_enqueue_scripts', 'base_disable_gutenberg_scripts' );
...
function base_disable_query_strings() {
...
function base_disable_head_links() {
